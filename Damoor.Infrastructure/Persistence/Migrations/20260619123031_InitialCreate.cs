        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionToken = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_CustomerIdentifier", "([UserId] IS NOT NULL AND [SessionToken] IS NULL) OR ([UserId] IS NULL AND [SessionToken] IS NOT NULL)");
                    table.CheckConstraint("CK_Orders_Status", "[Status] IN ('Pending', 'Confirmed', 'Processing', 'Shipped', 'Delivered', 'Cancelled')");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_SessionToken_CreatedAt",
                table: "Orders",
                columns: new[] { "SessionToken", "CreatedAt" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_ProductId_Active",
                table: "ProductImages",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingSessions_ExpiresAt",
                table: "ShoppingSessions",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingSessions_SessionToken",
                table: "ShoppingSessions",
                column: "SessionToken",
                unique: true);
