...
namespace Damoor.Infrastructure.Persistence.Migrations
{
    ...
    public partial class ChangeWishlistItemToVariant : Migration
    {
        ...
        {
            // Existing wishlist rows reference product ids, which have no valid
            // mapping to the new variant foreign key. Clear them before the
            // column is repurposed so the new FK can be created cleanly.
